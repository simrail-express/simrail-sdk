...
Katowice = Station(
    name="Katowice",
    lat=decimal.Decimal("50.2576"),
    lon=decimal.Decimal("19.0163"),
    mileage={
        1: decimal.Decimal("318.378"),
        137: decimal.Decimal("0.700"),
        138: decimal.Decimal("32.970"),
        139: decimal.Decimal("0"),
    },
...
KatowiceZawodzie = Station(
    ...
    lat=decimal.Decimal("50.257"),
    lon=decimal.Decimal("19.0576"),
    mileage={
        1: decimal.Decimal("315.653"),
        138: decimal.Decimal("30.243"),
    },
    radio_channels=[enums.RadioChannel.R2],
)
KatowiceSzopienicePoludniowe = Station(
    ...
    lat=decimal.Decimal("50.2589012"),
    lon=decimal.Decimal("19.0923178"),
    mileage={
        1: decimal.Decimal("312.91"),
        138: decimal.Decimal("27.505"),
    },
    radio_channels=[],
...
SosnowiecGlownyPZSR52 = Station(
    ...
    lat=decimal.Decimal("50.272162"),
    lon=decimal.Decimal("19.11472"),
...
SosnowiecGlowny = Station(
    ...
    lat=decimal.Decimal("50.279183"),
    lon=decimal.Decimal("19.126741"),
    mileage={1: 309.544, 62: 84.054},
    radio_channels=[enums.RadioChannel.R2],
)
Bedzin = Station(
    name="Będzin",
    lat=decimal.Decimal("50.3092276"),
    lon=decimal.Decimal("19.1411448"),
    mileage={1: 305.524},
    radio_channels=[enums.RadioChannel.R2],
)
BedzinMiasto = Station(
    lat=decimal.Decimal("50.3196"),
    lon=decimal.Decimal("19.1355"),
    name="Będzin Miasto",
    mileage={1: 304.385},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
...
BedzinKsawera = Station(
    lat=decimal.Decimal("50.330597"),
    lon=decimal.Decimal("19.158311"),
    name="Będzin Ksawera",
    mileage={1: 302.077},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
...
DabrowaGornicza = Station(
    ...
    lat=decimal.Decimal("50.33032"),
    lon=decimal.Decimal("19.184849"),
    mileage={1: 300.125},
    radio_channels=[enums.RadioChannel.R2],
)
DabrowaGorniczaGolonog = Station(
    lat=decimal.Decimal("50.343906"),
    lon=decimal.Decimal("19.226074"),
...
DabrowaGorniczaPogoria = Station(
    lat=decimal.Decimal("50.350486"),
    lon=decimal.Decimal("19.240869"),
...
DabrowaGorniczaZabkowice = Station(
    ...
    lat=decimal.Decimal("50.3665"),
    lon=decimal.Decimal("19.2646"),
...
DabrowaGorniczaSikorka = Station(
    lat=decimal.Decimal("50.3889"),
    lon=decimal.Decimal("19.299"),
...
Chruszczobrod = Station(
    lat=decimal.Decimal("50.3998056"),
    lon=decimal.Decimal("19.329232"),
    name="Chruszczobród",
...
Wiesiolka = Station(
    lat=decimal.Decimal("50.414670960748"),
    lon=decimal.Decimal("19.349284172058"),
    name="Wiesiółka",
...
LazyLC = Station(
    name="Łazy Łc",
    lat=decimal.Decimal("50.4292"),
    lon=decimal.Decimal("19.3907"),
...
Zawiercie = Station(
    name="Zawiercie",
    lat=decimal.Decimal("50.481"),
    lon=decimal.Decimal("19.423"),
    mileage={1: 274.227, 4: 224.050, 160: 274.227},
    radio_channels=[enums.RadioChannel.R2],
)
ZawiercieBorowePole = Station(
    lat=decimal.Decimal("50.5105"),
    lon=decimal.Decimal("19.3992"),
...
MyszkowMrzyglod = Station(
    lat=decimal.Decimal("50.5435993"),
    lon=decimal.Decimal("19.3770075"),
...
MyszkowSwiatowit = Station(
    ...
    lat=decimal.Decimal("0"),  # @TODO: placeholder
    lon=decimal.Decimal("0"),  # @TODO: placeholder
    mileage={1: 263.442},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
)
...
Zyrardow = Station(
    name="Żyrardów",
    lat=decimal.Decimal("50.2598"),  # @TODO: placeholder
    lon=decimal.Decimal("18.8622"),  # @TODO: placeholder
...
Pruszkow = Station(
    name="Pruszków",
    lat=decimal.Decimal("52.1683"),
    lon=decimal.Decimal("20.7987"),
    mileage={1: 15.891, 447: 15.891},
    radio_channels=[enums.RadioChannel.R2],
)
Jozefinow = Station(
    name="Józefinów",
    lat=decimal.Decimal("52.186014"),
    lon=decimal.Decimal("20.852936"),
...
WarszawaWlochy = Station(
    ...
    lat=decimal.Decimal("52.206206"),
    lon=decimal.Decimal("20.914761"),
...
WarszawaZachodnia = Station(
    ...
    lat=decimal.Decimal("52.22"),
    lon=decimal.Decimal("20.9652"),
...
WarszawaCentralna = Station(
    ...
    lat=decimal.Decimal("52.228765443166"),
    lon=decimal.Decimal("21.003338098526"),
    mileage={2: 0},
    radio_channels=[enums.RadioChannel.R2],
)
...
WarszawaWschodnia = Station(
    ...
    lat=decimal.Decimal("52.2515628"),
    lon=decimal.Decimal("21.052267"),
...
GrodziskMazowiecki = Station(
    ...
    lat=decimal.Decimal("52.1101"),
    lon=decimal.Decimal("20.6229"),
...
Korytow = Station(
    name="Korytów",
    lat=decimal.Decimal("52.020283"),
    lon=decimal.Decimal("20.495038"),
    mileage={4: 14.574},
    radio_channels=[enums.RadioChannel.R1],
)
Szeligi = Station(
    name="Szeligi",
    lat=decimal.Decimal("51.948"),
    lon=decimal.Decimal("20.461"),
    mileage={4: 23.542, 575: 2.974},
    radio_channels=[enums.RadioChannel.R1],
)
BialaRawska = Station(
    name="Biała Rawska",
    lat=decimal.Decimal("51.795"),
    lon=decimal.Decimal("20.4394"),
    mileage={4: 40.122},
    radio_channels=[enums.RadioChannel.R1],
    station_types=[enums.StationType.JUNCTION],
)
Strzalki = Station(
    name="Strzałki",
    lat=decimal.Decimal("51.6431"),
    lon=decimal.Decimal("20.4048"),
    mileage={4: 57.381},
    radio_channels=[enums.RadioChannel.R1],
)
Idzikowice = Station(
    name="Idzikowice",
    lat=decimal.Decimal("51.4486"),
    lon=decimal.Decimal("20.3105"),
    mileage={4: 80.738, 573: 0, 574: 4.597},
    radio_channels=[enums.RadioChannel.R1],
)
OpocznoPoludnie = Station(
    name="Opoczno Południe",
    lat=decimal.Decimal("51.3591"),
    lon=decimal.Decimal("20.2323"),
    mileage={4: 92.142},
    radio_channels=[enums.RadioChannel.R1],
)
Pilichowice = Station(
    name="Pilichowice",
    lat=decimal.Decimal("51.253696561736"),
    lon=decimal.Decimal("20.120944976807"),
    mileage={4: 106.588},
    radio_channels=[enums.RadioChannel.R1],
    station_types=[enums.StationType.JUNCTION],
)
Olszamowice = Station(
    name="Olszamowice",
    lat=decimal.Decimal("51.0916"),
    lon=decimal.Decimal("20.066"),
    mileage={4: 124.828},
    radio_channels=[enums.RadioChannel.R1],
)
WloszczowaPolnoc = Station(
    ...
    lat=decimal.Decimal("50.8567035"),
    lon=decimal.Decimal("19.9461079"),
    mileage={4: 154.390, 572: -0.740},
    radio_channels=[enums.RadioChannel.R1],
)
Knapowka = Station(
    name="Knapówka",
    lat=decimal.Decimal("50.8023"),
    lon=decimal.Decimal("19.906"),
...
Psary = Station(
    name="Psary",
    lat=decimal.Decimal("50.7336"),
    lon=decimal.Decimal("19.8163"),
    mileage={4: 170.479, 570: 0},
    radio_channels=[enums.RadioChannel.R1],
)
GoraWlodowska = Station(
    name="Góra Włodowska",
    lat=decimal.Decimal("50.5846"),
    lon=decimal.Decimal("19.4651"),
    mileage={4: 206.688},
    radio_channels=[enums.RadioChannel.R1],
)
...
KrakowGlowny = Station(
    name="Kraków Główny",
    lat=decimal.Decimal("50.0682894"),
    lon=decimal.Decimal("19.9479103"),
    mileage={8: 319.440},
    radio_channels=[enums.RadioChannel.R1],
    r307=True,
)
KrakowPrzedmiescie = Station(
    ...
    lat=decimal.Decimal("50.0847"),
    lon=decimal.Decimal("19.9498"),
    mileage={8: 317.426},
    radio_channels=[enums.RadioChannel.R1],
    station_types=[enums.StationType.JUNCTION],
)
KrakowBatowice = Station(
    ...
    lat=decimal.Decimal("50.1074511"),
    lon=decimal.Decimal("19.9955463"),
    mileage={8: 313.275},
    radio_channels=[enums.RadioChannel.R1],
)
Raciborowice = Station(
    name="Raciborowice",
    lat=decimal.Decimal("50.110836"),
    lon=decimal.Decimal("20.02813"),
    mileage={8: 310.832},
    radio_channels=[enums.RadioChannel.R1],
    station_types=[enums.StationType.JUNCTION],
)
Zastow = Station(
    name="Zastów",
    lat=decimal.Decimal("50.1237424"),
    lon=decimal.Decimal("20.0690603"),
    mileage={8: 307.946},
    radio_channels=[enums.RadioChannel.R1],
)
Baranowka = Station(
...
Niedzwiedz = Station(
    name="Niedźwiedź",
    lat=decimal.Decimal("50.2043191"),
    lon=decimal.Decimal("20.0809479"),
    mileage={8: 295.782},
    radio_channels=[enums.RadioChannel.R1],
)
...
Miechow = Station(
    name="Miechów",
    lat=decimal.Decimal("50.353"),
    lon=decimal.Decimal("20.0104"),
    mileage={8: 277.343},
    is_boundary=True,
    radio_channels=[enums.RadioChannel.R1],
)
Kozlow = Station(
    name="Kozłów",
    lat=decimal.Decimal("50.4748"),
    lon=decimal.Decimal("20.0121"),
    mileage={8: 262.098, 64: 0},
    radio_channels=[enums.RadioChannel.R4],
)
Klimontow = Station(
    name="Klimontów",
    lat=decimal.Decimal("50.525388"),
    lon=decimal.Decimal("20.030168"),
    mileage={8: 256.243},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
)
Gniewiecin = Station(
    name="Gniewiecin",
    lat=decimal.Decimal("50.540817"),
    lon=decimal.Decimal("20.044427"),
    mileage={8: 254.285},
...
Sedziszow = Station(
    name="Sędziszów",
    lat=decimal.Decimal("50.5659"),
    lon=decimal.Decimal("20.0549"),
    mileage={8: 251.232},
    radio_channels=[enums.RadioChannel.R4],
)
...
Radzice = Station(
    name="Radzice",
    lat=decimal.Decimal("51.466734509069"),
    lon=decimal.Decimal("20.397191047668"),
...
Czarnca = Station(
    name="Czarnca",
    lat=decimal.Decimal("50.8238578"),
    lon=decimal.Decimal("19.9446487"),
...
Zelislawice = Station(
    name="Żelisławice",
    lat=decimal.Decimal("50.80373793"),
    lon=decimal.Decimal("19.858560562134"),
...
Tunel = Station(
    name="Tunel",
    lat=decimal.Decimal("50.433946533387"),
    lon=decimal.Decimal("19.991426467896"),
...
Charsznica = Station(
    name="Charsznica",
    lat=decimal.Decimal("50.3962"),
    lon=decimal.Decimal("19.9408"),
    mileage={62: 7.793},
    radio_channels=[enums.RadioChannel.R4],
)
Gajowka = Station(
    lat=decimal.Decimal("50.394642"),
    lon=decimal.Decimal("19.878629"),
    name="Gajówka",
    mileage={62: 12.5},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
...
Jezowka = Station(
    lat=decimal.Decimal("50.39931"),
    lon=decimal.Decimal("19.815715"),
    name="Jeżówka",
    mileage={62: 16.894},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
...
Wolbrom = Station(
    name="Wolbrom",
    lat=decimal.Decimal("50.375983"),
    lon=decimal.Decimal("19.77229"),
    mileage={62: 22.296},
    radio_channels=[enums.RadioChannel.R4],
    remote_control_facilities=True,
)
Zarzecze = Station(
    lat=decimal.Decimal("50.363169"),
    lon=decimal.Decimal("19.698545"),
    name="Zarzecze",
    mileage={62: 28.0},
    radio_channels=[],
    station_types=[enums.StationType.HALT],
...
ChrzastowiceOlkuskie = Station(
    lat=decimal.Decimal("50.343208"),
    lon=decimal.Decimal("19.68507"),
...
JaroszowiecOlkuski = Station(
    ...
    lat=decimal.Decimal("50.342235"),
    lon=decimal.Decimal("19.621598"),
    mileage={62: 35.744},
    radio_channels=[enums.RadioChannel.R4],
)
Olkusz = Station(
    name="Olkusz",
    lat=decimal.Decimal("50.274383"),
    lon=decimal.Decimal("19.570979"),
    mileage={62: 45.021},
    radio_channels=[enums.RadioChannel.R4],
)
Bukowno = Station(
    name="Bukowno",
    lat=decimal.Decimal("50.26390811538"),
    lon=decimal.Decimal("19.458825588226"),
    mileage={62: 53.538},
    radio_channels=[enums.RadioChannel.R4],
)
BukownoPrzymiarki = Station(
    lat=decimal.Decimal("50.27536"),
    lon=decimal.Decimal("19.409215"),
...
Slawkow = Station(
    name="Sławków",
    lat=decimal.Decimal("50.295464"),
    lon=decimal.Decimal("19.373682"),
    mileage={62: 61.261},
    radio_channels=[enums.RadioChannel.R4],
)
DabrowaGorniczaWschodnia = Station(
    ...
    lat=decimal.Decimal("50.3033"),
    lon=decimal.Decimal("19.3104"),
...
DabrowaGorniczaStrzemieszyce = Station(
    ...
    lat=decimal.Decimal("50.3109"),
    lon=decimal.Decimal("19.2681"),
...
SosnowiecKazimierz = Station(
    ...
    lat=decimal.Decimal("50.2882425"),
    lon=decimal.Decimal("19.2316961"),
...
SosnowiecPorabka = Station(
    lat=decimal.Decimal("50.272042"),
    lon=decimal.Decimal("19.216252"),
...
SosnowiecDandowka = Station(
    ...
    lat=decimal.Decimal("50.2655"),
    lon=decimal.Decimal("19.1736"),
...
SosnowiecPoludniowy = Station(
    ...
    lat=decimal.Decimal("50.269723712063"),
    lon=decimal.Decimal("19.125287532806"),
...
Sprowa = Station(
    name="Sprowa",
    lat=decimal.Decimal("50.5926"),
    lon=decimal.Decimal("19.8828"),
    mileage={64: 17.675},
    radio_channels=[enums.RadioChannel.R5],
    station_types=[enums.StationType.JUNCTION],
)
Starzyny = Station(
    name="Starzyny",
    lat=decimal.Decimal("50.715"),
    lon=decimal.Decimal("19.8002"),
...
ChorzowBatory = Station(
    name="Chorzów Batory",
    lat=decimal.Decimal("50.278559"),
    lon=decimal.Decimal("18.945054"),
...
RudaChebzie = Station(
    name="Ruda Chebzie",
    lat=decimal.Decimal("50.303725"),
    lon=decimal.Decimal("18.877553"),
    mileage={137: 11.740},
    radio_channels=[enums.RadioChannel.R2],
)
RudaSlaska = Station(
...
Zabrze = Station(
    name="Zabrze",
    lat=decimal.Decimal("50.305349"),
    lon=decimal.Decimal("18.787184"),
    mileage={137: 18.926},
    radio_channels=[enums.RadioChannel.R2],
)
Gliwice = Station(
    name="Gliwice",
    lat=decimal.Decimal("50.300826"),
    lon=decimal.Decimal("18.676232"),
    mileage={137: 27.100},
    radio_channels=[enums.RadioChannel.R2],
)
...
RudaWirek = Station(
    name="Ruda Wirek",
    lat=decimal.Decimal("50.2598"),
    lon=decimal.Decimal("18.8622"),
    mileage={141: 10.386},
    radio_channels=[enums.RadioChannel.R5],
    radio_recording=False,
    station_types=[enums.StationType.BLOCK_POST],
...
RudaKochlowice = Station(
    ...
    lat=decimal.Decimal("50.2566445"),
    lon=decimal.Decimal("18.908329"),
...
Koziol = Station(
    name="Kozioł",
    lat=decimal.Decimal("50.3078"),
    lon=decimal.Decimal("19.3796"),
...
Dorota = Station(
    name="Dorota",
    lat=decimal.Decimal("50.2815"),
    lon=decimal.Decimal("19.2792"),
...
Juliusz = Station(
    name="Juliusz",
    lat=decimal.Decimal("50.272186"),
    lon=decimal.Decimal("19.225194"),
    mileage={171: 20.746},
    radio_channels=[enums.RadioChannel.R5],
    station_types=[enums.StationType.JUNCTION],
)
...
BohuminVrbice = Station(
    name="Bohumin Vrbice",
    lat=decimal.Decimal("49.882"),
    lon=decimal.Decimal("18.3231"),
    mileage={592: 0},
    radio_channels=[enums.RadioChannel.R6],
)
...
Hajduki = Station(
    name="Hajduki",
    lat=decimal.Decimal("50.262818"),
    lon=decimal.Decimal("18.941401"),
...
Gottwald = Station(
    name="Gottwald",
    lat=decimal.Decimal("50.271973"),
    lon=decimal.Decimal("18.9617372"),
...
WarszawaGrochow = Station(
    ...
    lat=decimal.Decimal("52.256232"),
    lon=decimal.Decimal("21.082431"),
...
KWKStaszic = Station(
    ...
    lat=decimal.Decimal("50.227"),
    lon=decimal.Decimal("19.0474"),
    mileage={898: 3.700},
    radio_channels=[enums.RadioChannel.R3],
    station_types=[enums.StationType.TECHNICAL_STATION],
    is_boundary=True,
...
Staszic = Station(
    name="Staszic",
    lat=decimal.Decimal("50.218679"),
    lon=decimal.Decimal("19.0013"),
